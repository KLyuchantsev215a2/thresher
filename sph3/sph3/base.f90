...
!spatial integration method  SPH
    ...
    integer N!the number of particles that sample the environment
    ...
    real dt,lifetime!time step, time during calculation
    
    real, allocatable :: x(:,:)
    real, allocatable :: x_old(:,:)
    real, allocatable :: v(:,:)
    ...
    do step=1,int(T/dt)
        x_0=x
        v_0_0=v
        call Compute_Acceleration(N,h,dh,rho_0,mu,k,vol,F,C,x_0,x_old,nabla_W_0,nabla_W,W,Wper1,Wper2,acc)
        x_n_1=x_0+dt*v_0_0
        v_n_1=v_0_0+dt*acc
        call Compute_Acceleration(N,h,dh,rho_0,mu,k,vol,F,C,x_n_1,x_old,nabla_W_0,nabla_W,W,Wper1,Wper2,acc)
        x_n_2=x_n_1+dt*v_n_1
        v_n_2=v_n_1+dt*acc
        x_n_1_2=3.0/4.0*x_0+1.0/4.0*x_n_2
        v_n_1_2=3.0/4.0*v_0_0+1.0/4.0*v_n_2
        call Compute_Acceleration(N,h,dh,rho_0,mu,k,vol,F,C,x_n_1_2,x_old,nabla_W_0,nabla_W,W,Wper1,Wper2,acc)
